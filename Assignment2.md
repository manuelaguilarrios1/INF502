...
~                                                                                                                       ~                                                                                                                       ~                                                                                                                       ~                                                                                                                       ~                                                                                                                       ~                                                                                                                       ~                                                                                                                       ~  
 Merge branch 'math' into master
```
Part 2: For this I went to Igor's repository at https://github.com/igorsteinmacher/INF502-Fall2020. I clicked on the fork icon on the top right corner of my browser and created a clone fo the repository on my account. I created my AGUILAR_MANUEL.md file in the students folder. I then submitted a pull request by clicking the pull request button at the bottom of my AGUILAR_MANUEL.md file. 
